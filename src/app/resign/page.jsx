...
const Resign = () => {
  ...
  useEffect(() => {
    setIsNextEnabled(
      firstChecked || twiceChecked || thirdChecked || (fourthChecked && textareaValue.trim() !== '')
    )
          ...
          <div className={styles.guide}>
            ...
            <p className={styles.explanation}>
              * 기존에 작성하신 모든 후기는 자동으로 삭제되지 않으며, 탈퇴
              이후에는 작성자 정보를 찾을 수 없어 삭제가 불가능합니다. 후기
              삭제를 원하시는 경우 탈퇴 전 직접 삭제하시 거나, 문의하기를 통해
              삭제요청 후 결과를 확인하시고 탈퇴를 진행해주세요.
              <br />
